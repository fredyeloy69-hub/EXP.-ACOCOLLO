...
const COLORES_NIVEL_SEPARADOR = [
  ...
  { base: "FFB33A3A", factor: 0.68 }, // nivel 3: rojo, más claro
];
...
export async function generarListaSeparadoresExcel(areaNombre, carpetasDelArea) {
  ...
  for (const item of items) {
    ...
    // creciente (nivel 1 el más oscuro, nivel 3 el más claro). Solo se
    // sombrean los primeros 3 niveles; del nivel 4 en adelante, sin sombra.
    if (item.nivel <= 2) {
