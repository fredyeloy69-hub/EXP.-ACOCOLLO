...
const COLLAPSE_STORAGE_KEY = "acocollo_grupos_colapsados";
...
export default function Dashboard() {
  ...
  function handleExportarArea(areaNombre, carpetasDelArea) {
    ...
    try {
      const usuarioFirma = usuarioGoogle?.email || usuarioGoogle?.displayName || "Sistema Acocollo";
      ...
      <div className="chijnaya-header-sticky">
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            />
            <div>
              <h1 style={{ fontSize: modoPresentacion ? 36 : 24, marginBottom: 4, fontWeight: 800, letterSpacing: -0.3 }}>Expediente Técnico — C.S. Acocollo</h1>
...
function RutaJerarquica({ ruta, nombre, skipLevels = 2 }) {
